...
export default function Search() {
    ...
    const handleSubmit = (e) => {
        ...
        urlParams.set('parking', sidebardata.parking); // Convert boolean to string
        urlParams.set('furnished', sidebardata.furnished); // Convert boolean to string
        urlParams.set('offer', sidebardata.offer); // Convert boolean to string
