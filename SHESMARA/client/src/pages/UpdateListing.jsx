...
export default function UpdateListing() {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountPrice) return setError('discount price shld be lower then regular price')
            setLoading(true);
            setError(false);
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form  onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className=" flex flex-col  gap-4 flex-1">
                ...
                rounded-lg ' id='name' maxLength='80' required  onChange={handleChange} value={formData.name}  />
                ...
                <div className='flex gap-6 flex-wrap'>
                    ...
                    <div className="flex gap-4">
                        <input type="checkbox" id='pg' className='w-5' onChange={handleChange} checked={formData.type === 'pg'}  />
                        <span>PG</span>
                    </div>
                    <div className="flex gap-4">
                ...
                <div className=" flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {formData.offer && (
                            <div className="flex items-center gap-2">
                        <input type="number" id="discountPrice" min='50'  required 
